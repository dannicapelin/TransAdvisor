...
class InstitutionsControllerTest < ActionController::TestCase
  ...
  test "should create institution" do
    assert_difference('Institution.count') do
      post :create, institution: { address: @institution.address, link: @institution.link, name: @institution.name, telephone: @institution.telephone }
    end
  ...
  test "should update institution" do
    patch :update, id: @institution, institution: { address: @institution.address, link: @institution.link, name: @institution.name, telephone: @institution.telephone }
    assert_redirected_to institution_path(assigns(:institution))
  end
